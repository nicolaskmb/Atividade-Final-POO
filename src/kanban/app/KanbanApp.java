...
public class KanbanApp {
    ...
    private static void editarCartao(Lista lista) {
        ...
        if (escolha > 0 && escolha <= lista.getCartoes().size()) {
            ...
            System.out.println("1. Editar Nome do Cartão");
            System.out.println("2. Atualizar Status do Cartão");
            System.out.print("Escolha uma opção: ");
            int opcao = scanner.nextInt();
            scanner.nextLine(); // Consumir nova linha
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    switch (statusEscolha) {
                        case 1:
                            cartaoParaEditar.setStatus(StatusCartao.A_FAZER);
                            break;
                        case 2:
                            cartaoParaEditar.setStatus(StatusCartao.EM_PROGRESSO);
                            break;
                        case 3:
                            cartaoParaEditar.setStatus(StatusCartao.CONCLUIDO);
                            break;
                        default:
                            System.out.println("Escolha inválida. Status não atualizado.");
                            return;
                    }
                    System.out.println("Status do cartão atualizado com sucesso.");
                    break;
                default:
                    System.out.println("Escolha inválida. Tente novamente.");
            }
